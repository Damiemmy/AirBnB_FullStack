...
urlpatterns=[
    ...
    path('<uuid:pk>/reservations/',api.properties_reservation,name='api_property_reservations'),
    path('<uuid:pk>/toggle_favorite/',api.toggle_favorite,name='api_toogle_favorite')
]